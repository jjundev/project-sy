#!/usr/bin/env python3
"""
Generate data/ybm_part3.js for YBM 미적분 I - Part 3: 적분
Strict 4-Grid-Lock: Exactly 44 problems (11 pages * 4 problems/page)
Student Name Rule: meta.student is "" (empty), generic cheer.
Zero Naked LaTeX & 3-Step Pedagogy enforced.
"""
...
with open('assets/figures/ybm_part3_p34.svg', 'r', encoding='utf-8') as f:
    svg_p34 = f.read().strip()
b64_p34 = base64.b64encode(svg_p34.encode('utf-8')).decode('ascii')
data_uri_p34 = f"data:image/svg+xml;base64,{b64_p34}"
...
problems = [
    # 01 [p.119 확인 3]
    {
        ...
        "solution": {
            ...
            "steps": [
                {"label": "1단계", "content": "함수 $(x-2)^4$의 한 부정적분이 $f(x)$이므로 부정적분의 정의에 따라 다음이 성립합니다.\n$f'(x) = (x-2)^4$"},
                {"label": "2단계", "content": "구하고자 하는 값은 $f'(3)$이므로 도함수에 $x=3$을 대입합니다."},
                {"label": "3단계", "content": "$f'(3) = (3-2)^4 = 1^4 = 1$\n따라서 구하는 값은 $1$입니다."}
            ]
        }
    },
    # 02 [p.123 예제 2]
    {
        ...
        "solution": {
            ...
            "steps": [
                {"label": "1단계", "content": "도함수 $f'(x)=3x^2+4x-2$의 양변을 적분하여 $f(x)$를 구합니다.\n$f(x) = \\int (3x^2+4x-2)dx = x^3+2x^2-2x+C$ (단, $C$는 적분상수)"},
                {"label": "2단계", "content": "초기조건 $f(-1)=1$을 식에 대입합니다.\n$f(-1) = (-1)^3+2(-1)^2-2(-1)+C = -1+2+2+C = 3+C = 1$\n따라서 $C = -2$입니다."},
                {"label": "3단계", "content": "구한 적분상수를 대입하면 구하는 함수는 다음과 같습니다.\n$f(x) = x^3+2x^2-2x-2$"}
            ]
        }
    },
    # 03 [p.124 확인 3]
    {
        ...
        "solution": {
            ...
            "steps": [
                {"label": "1단계", "content": "주어진 부정적분 등식의 양변을 $x$에 대하여 미분하면 $f(x)$를 얻을 수 있습니다.\n$f(x) = \\frac{d}{dx}(4x^3-3x^2+2x+C) = 12x^2-6x+2$"},
                {"label": "2단계", "content": "피적분함수 $xf(x)$를 구하면 다음과 같습니다.\n$xf(x) = x(12x^2-6x+2) = 12x^3-6x^2+2x$"},
                {"label": "3단계", "content": "미적분의 기본정리에 따라 $G(2)-G(1) = \\int_1^2 xf(x)dx$이므로 정적분을 계산합니다.\n$\\int_1^2 (12x^3-6x^2+2x)dx = [3x^4-2x^3+x^2]_1^2$\n$= (3\\times 16 - 2\\times 8 + 4) - (3 - 2 + 1) = (48 - 16 + 4) - 2 = 36 - 2 = 34$"}
            ]
        }
    },
    # 04 [p.124 확인 5]
    ...
    # 05 [p.134 확인 2]
    {
        ...
        "solution": {
            ...
            "steps": [
                {"label": "1단계", "content": "주어진 등식의 양변을 $x$에 대하여 미분합니다.\n$\\frac{d}{dx}\\left(\\int_a^x f(t)dt\\right) = f(x) = \\frac{d}{dx}(x^2-3x+2) = 2x-3$"},
                {"label": "2단계", "content": "정적분의 성질에 의해 $\\int_a^a f(t)dt = 0$이므로 양변에 $x=a$를 대입합니다.\n$a^2-3a+2 = 0$"},
                {"label": "3단계", "content": "이차방정식을 인수분해하면 $(a-1)(a-2)=0$이므로 $a=1$ 또는 $a=2$입니다.\n따라서 $f(x)=2x-3$, $a=1$ 또는 $a=2$입니다."}
            ]
        }
    },
    # 06 [p.134 확인 3(1)]
    ...
    # 07 [p.134 확인 4]
    {
        ...
        "solution": {
            ...
            "steps": [
                {"label": "1단계", "content": "정적분 $\\int_0^2 f(t)dt = k$ ($k$는 상수)로 놓으면 $f(x) = 2x^3-x+k$입니다."},
                {"label": "2단계", "content": "이 식을 치환한 정적분 정의에 대입합니다.\n$\\int_0^2 (2t^3-t+k)dt = \\left[\\frac{1}{2}t^4-\\frac{1}{2}t^2+kt\\right]_0^2 = (8-2+2k) - 0 = 6+2k = k$\n$2k-k = -6 \\implies k = -6$"},
                {"label": "3단계", "content": "따라서 $f(x) = 2x^3-x-6$이므로 $x=1$을 대입합니다.\n$f(1) = 2(1)^3 - 1 - 6 = 2 - 1 - 6 = -5$"}
            ]
        }
    },
    # 08 [p.134 확인 5]
    ...
    # 16 [대단원 01]
    {
        ...
        "solution": {
            ...
            "steps": [
                {"label": "1단계", "content": "$f(x) = \\int (3x^2-2)dx = x^3-2x+C$ (단, $C$는 적분상수)"},
                {"label": "2단계", "content": "$f(0)=4$이므로 $C=4$입니다.\n따라서 $f(x) = x^3-2x+4$입니다."},
                {"label": "3단계", "content": "$f(3) = 3^3-2(3)+4 = 27-6+4 = 25$\n따라서 정답은 ③입니다."}
            ]
        }
    },
    # 17 [대단원 02]
    {
        ...
        "solution": {
            ...
            "steps": [
                {"label": "1단계", "content": "접선의 기울기가 $f'(x) = 3x^2+8x$입니다.\n양변을 부정적분하면 $f(x) = \\int (3x^2+8x)dx = x^3+4x^2+C$ (단, $C$는 적분상수)"},
                {"label": "2단계", "content": "곡선이 원점을 지나므로 $f(0)=0$에서 $C=0$입니다.\n따라서 $f(x) = x^3+4x^2$입니다."},
                {"label": "3단계", "content": "$f(-2) = (-2)^3+4(-2)^2 = -8 + 16 = 8$\n따라서 정답은 ⑤입니다."}
            ]
        }
    },
    # 18 [대단원 03]
    ...
    # 19 [대단원 04]
    {
        ...
        "choices": ["$61$", "$62$", "$63$", "$64$", "$65$"],
        "solution": {
            "answer": "④",
            "tip": "$\\frac{d}{dx}\\int g(x)dx = g(x)$ 성질을 활용하여 $f(x)$에 대한 방정식을 풉니다.",
            "steps": [
                {"label": "1단계", "content": "부정적분을 한 후 미분하면 피적분함수 자신이 되므로\n$\\frac{d}{dx}\\int \\{3f(x)-2x^3\\}dx = 3f(x)-2x^3$입니다."},
                {"label": "2단계", "content": "따라서 주어진 식은 $f(x) = 3f(x)-2x^3$이 됩니다.\n이항하여 정리하면 $2f(x) = 2x^3 \\implies f(x) = x^3$입니다."},
                {"label": "3단계", "content": "$f(4) = 4^3 = 64$\n따라서 정답은 ④입니다."}
            ]
        }
    },
    # 20 [대단원 05]
    {
        ...
        "choices": ["$-\\frac{5}{3}$", "$-\\frac{4}{3}$", "$-1$", "$-\\frac{2}{3}$", "$-\\frac{1}{3}$"],
        "solution": {
            "answer": "④",
            "tip": "조건 (가)의 양변을 $x$에 대해 미분하여 $f'(x)$를 구하고, $F(1)=1$을 대입하여 $f(0)$을 구합니다.",
            "steps": [
                {"label": "1단계", "content": "조건 (가) $F(x)=xf(x)+x^4-2x^2$의 양변을 $x$에 대하여 미분하면\n$f(x) = f(x) + xf'(x) + 4x^3-4x$\n$xf'(x) = -4x^3+4x$에서 $f'(x) = -4x^2+4$입니다."},
                {"label": "2단계", "content": "$f(x) = \\int (-4x^2+4)dx = -\\frac{4}{3}x^3+4x+C$ (단, $C$는 적분상수)\n조건 (가)에 $x=1$을 대입하면 $F(1) = f(1)+1-2 = f(1)-1$입니다.\n조건 (나)에서 $F(1)=1$이므로 $f(1)-1=1 \\implies f(1)=2$입니다."},
                {"label": "3단계", "content": "$f(1) = -\\frac{4}{3}+4+C = \\frac{8}{3}+C = 2 \\implies C = -\\frac{2}{3}$\n따라서 $f(0) = C = -\\frac{2}{3}$이므로 정답은 ④입니다."}
            ]
        }
    },
    # 21 [대단원 06]
    {
        ...
        "solution": {
            ...
            "steps": [
                {"label": "1단계", "content": "$-\\int_2^1 (3x^2+x)dx = \\int_1^2 (3x^2+x)dx$이므로 주어진 식은 다음과 같습니다.\n$\\int_{-2}^1 (3x^2+x)dx + \\int_1^2 (3x^2+x)dx = \\int_{-2}^2 (3x^2+x)dx$"},
                {"label": "2단계", "content": "적분 구간이 $[-2, 2]$로 대칭이므로 기함수 $x$는 $0$이 되고, 우함수 $3x^2$만 남습니다.\n$\\int_{-2}^2 (3x^2+x)dx = 2\\int_0^2 3x^2 dx$"},
                {"label": "3단계", "content": "$2\\int_0^2 3x^2 dx = 2[x^3]_0^2 = 2\\times 8 = 16$\n따라서 정답은 ①입니다."}
            ]
        }
    },
    # 22 [대단원 07]
    ...
    # 23 [대단원 08]
    {
        ...
        "solution": {
            ...
            "steps": [
                {"label": "1단계", "content": "$f(t)$의 한 부정적분을 $F(t)$라 하면 $\\int_1^x f(t)dt = F(x)-F(1)$입니다."},
                {"label": "2단계", "content": "미분계수의 정의에 의해 다음이 성립합니다.\n$\\lim_{x\\to 1}\\frac{1}{x-1}\\int_1^x f(t)dt = \\lim_{x\\to 1}\\frac{F(x)-F(1)}{x-1} = F'(1) = f(1)$"},
                {"label": "3단계", "content": "$f(1) = 2(1)^3+6(1)^2-5 = 2+6-5 = 3$\n따라서 정답은 ③입니다."}
            ]
        }
    },
    # 24 [대단원 09]
    {
        ...
        "solution": {
            ...
            "steps": [
                {"label": "1단계", "content": "주어진 등식에 $x=1$을 대입하면 좌변은 $\\int_1^1 f(t)dt = 0$이므로\n$1^3-3(1)^2+a(1) = 1-3+a = 0 \\implies a = 2$입니다."},
                {"label": "2단계", "content": "양변을 $x$에 대하여 미분합니다.\n$\\frac{d}{dx}\\left(\\int_1^x f(t)dt\\right) = f(x) = \\frac{d}{dx}(x^3-3x^2+2x) = 3x^2-6x+2$"},
                {"label": "3단계", "content": "$f(1) = 3(1)^2-6(1)+2 = 3-6+2 = -1$\n따라서 $a+f(1) = 2 + (-1) = 1$이므로 정답은 ①입니다."}
            ]
        }
    },
    # 25 [대단원 10]
    ...
    # 28 [대단원 13]
    {
        ...
        "solution": {
            ...
            "steps": [
                {"label": "1단계", "content": "좌변을 전개하면 $x\\int_0^x f(t)dt - \\int_0^x tf(t)dt = \\frac{3}{4}x^4-5x^2$입니다.\n양변을 $x$에 대하여 미분하면\n$\\int_0^x f(t)dt + xf(x) - xf(x) = \\int_0^x f(t)dt = 3x^3-10x$입니다."},
                {"label": "2단계", "content": "다시 한 번 양변을 $x$에 대하여 미분하면\n$f(x) = 9x^2-10$입니다."},
                {"label": "3단계", "content": "$f(x) = 9x^2-10$은 아래로 볼록한 포물선이므로 $x=0$일 때 최솟값을 갖습니다.\n따라서 최솟값은 $f(0) = -10$이므로 정답은 ①입니다."}
            ]
        }
    },
    # 29 [대단원 14]
    ...
    # 30 [대단원 15]
    {
        ...
        "solution": {
            ...
            "steps": [
                {"label": "1단계", "content": "곡선과 $x$축의 교점의 $x$좌표는 $x^3(x-1)=0$에서 $x=0$ 또는 $x=1$입니다.\n구간 $[0, 1]$에서 $x^3 \\ge 0$, $x-1 \\le 0$이므로 $x^3(x-1) \\le 0$입니다."},
                {"label": "2단계", "content": "따라서 둘러싸인 도형의 넓이 $S$는 다음과 같습니다.\n$S = \\int_0^1 -x^3(x-1)dx = \\int_0^1 (-x^4+x^3)dx$"},
                {"label": "3단계", "content": "$S = \\left[-\\frac{1}{5}x^5+\\frac{1}{4}x^4\\right]_0^1 = -\\frac{1}{5}+\\frac{1}{4} = \\frac{1}{20}$\n따라서 정답은 ①입니다."}
            ]
        }
    },
    # 31 [대단원 16]
    ...
    # 35 [대단원 20]
    {
        ...
        "solution": {
            ...
            "steps": [
                {"label": "1단계", "content": "두 점 모두 원점을 출발하였으므로 시각 $t$에서의 위치 $x_P(t), x_Q(t)$는 속도의 정적분입니다.\n$x_P(t) = \\int_0^t 6u^2 du = [2u^3]_0^t = 2t^3$\n$x_Q(t) = \\int_0^t (6u+9) du = [3u^2+9u]_0^t = 3t^2+9t$"},
                {"label": "2단계", "content": "두 점이 다시 만나는 순간은 $x_P(t) = x_Q(t)$ ($t>0$)입니다.\n$2t^3 = 3t^2+9t \\implies 2t^3-3t^2-9t = 0$\n$t(2t^2-3t-9) = 0 \\implies t(2t+3)(t-3) = 0$"},
                {"label": "3단계", "content": "$t>0$이므로 구하는 시각은 $t=3$입니다.\n따라서 $a=3$이므로 정답은 ⑤입니다."}
            ]
        }
    },
    # 36 [대단원 21]
    {
        ...
        "solution": {
            ...
            "steps": [
                {"label": "1단계", "content": "$x(0)=0$, $x(2)=0$이므로 $t=0$과 $t=2$에서의 위치는 모두 원점입니다.\n따라서 위치의 변화량은 $\\int_0^2 v(t)dt = x(2)-x(0) = 0 - 0 = 0$입니다. (ㄱ 참)"},
                {"label": "2단계", "content": "점 $\\mathrm{P}$가 $t=0$에서 $t=2$까지 움직인 총 거리는 $\\int_0^2 |v(t)|dt = 4$입니다.\n만약 어떤 $t_1 \\in (0, 2)$에서 $|x(t_1)| > 2$라면, 원점에서 $x(t_1)$까지 갔다가 다시 $t=2$에서 원점으로 돌아와야 하므로 움직인 거리는 적어도 $2|x(t_1)| > 4$가 되어 모순입니다. 따라서 $|x(t_1)| > 2$일 수 없습니다. (ㄴ 거짓)"},
                {"label": "3단계", "content": "모든 $t \\in [0, 2]$에서 $|x(t)| < 2$인데 왕복 거리가 $4$가 되려면 점 $\\mathrm{P}$는 양의 방향과 음의 방향을 모두 방문해야 합니다. 즉, 양수인 위치와 음수인 위치를 모두 거치므로 사이값 정리에 의해 $x(t_2)=0$인 $t_2$가 열린구간 $(0, 2)$에 적어도 하나 존재합니다. (ㄷ 참)\n따라서 옳은 것은 ㄱ, ㄷ이므로 정답은 ③입니다."}
            ]
        }
    },
    # 37 [대단원 22]
    {
        ...
        "solution": {
            ...
            "steps": [
                {"label": "1단계", "content": "$\\int_0^1 f(t)dt = k$ ($k$는 상수)로 놓으면 함수는 다음과 같이 표현됩니다.\n$f(x) = 3x^2 + 2k$"},
                {"label": "2단계", "content": "이 식을 치환한 정적분 정의에 대입하여 $k$의 값을 구합니다.\n$\\int_0^1 (3t^2+2k)dt = [t^3+2kt]_0^1 = 1+2k$\n$1+2k = k \\implies k = -1$"},
                {"label": "3단계", "content": "따라서 $f(x) = 3x^2 - 2$입니다.\n$x=3$을 대입하면\n$f(3) = 3(3)^2 - 2 = 27 - 2 = 25$"}
            ]
        }
    },
    # 38 [대단원 23]
    ...
    # 41 [쌍둥이 22]
    {
        ...
        "solution": {
            ...
            "steps": [
                {"label": "1단계", "content": "$\\int_0^1 f(t)dt = k$ ($k$는 상수)로 놓으면\n$f(x) = 6x^2+2k$입니다."},
                {"label": "2단계", "content": "치환한 식을 정적분에 대입합니다.\n$\\int_0^1 (6t^2+2k)dt = [2t^3+2kt]_0^1 = 2+2k$\n$2+2k = k \\implies k = -2$"},
                {"label": "3단계", "content": "따라서 $f(x) = 6x^2-4$입니다.\n$x=2$를 대입하면 $f(2) = 6(2)^2-4 = 24-4 = 20$입니다."}
            ]
        }
    },
    # 42 [쌍둥이 23]
    {
        ...
        "solution": {
            ...
            "steps": [
                ...
                {"label": "2단계", "content": "구간 $[0, a+1]$에서 직선이 곡선보다 위쪽에 있으므로 둘러싸인 넓이 $S$는 다음과 같습니다.\n$S = \\int_0^{a+1} \\{ax-(x^2-x)\\}dx = \\frac{(a+1)^3}{6}$"},
...
for p in problems:
    ...
    if "formula" not in p:
        p["formula"] = ""
    if "subQuestions" not in p:
        p["subQuestions"] = []
    if "tip" not in p:
        p["tip"] = sol.get("tip", "")
    if "answer" not in p:
        p["answer"] = sol.get("answer", "")
    if "choices" not in p:
        p["choices"] = []
    if "solution" in p and "steps" in sol:
        p["solution"] = {
            "steps": sol["steps"]
        }
...
with open('data/ybm_part3.js', 'w', encoding='utf-8') as f:
    f.write("window.WORKSHEET_DATA = ")
    json.dump(worksheet_data, f, ensure_ascii=False, indent=2)
    f.write(";\n")

print(f"Generated data/ybm_part3.js with {len(problems)} problems.")
